...
class WekaClassifier {
    ...
    public static double classify(Object[] i) throws Exception {
        ...
        double p = Double.NaN;
        p = WekaClassifier.N2955cf310(i);
        return p;
    }

    static double N2955cf310(Object[] i) {
        double p = Double.NaN;
        if (i[0] == null) {
            p = 1;
        } else if (i[0].equals("sunny")) {
            p = WekaClassifier.N559c2ed11(i);
        } else if (i[0].equals("overcast")) {
            p = 0;
        } else if (i[0].equals("rainy")) {
            p = WekaClassifier.N7671f7c72(i);
        }
        return p;
    }

    static double N559c2ed11(Object[] i) {
        double p = Double.NaN;
        if (i[2] == null) {
            p = 1;
    ...
    static double N7671f7c72(Object[] i) {
        double p = Double.NaN;
        if (i[3] == null) {
            p = 1;
